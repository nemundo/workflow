...
class WikiContentTypeExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
parent::loadType();
$this->externalModelClassName = WikiContentTypeModel::class;
$this->externalTableName = "wiki_wiki_content_type";
