...
$this->statusChange = new \Nemundo\Workflow\App\Workflow\Data\WorkflowStatusChange\WorkflowStatusChangeExternalType(null, $this->parentFieldName . "_status_change");
