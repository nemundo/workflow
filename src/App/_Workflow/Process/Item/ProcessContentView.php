...
use Nemundo\Workflow\App\Workflow\ContentItem\WorkflowItemContentView;
...
class ProcessContentView extends AbstractContentView
{
    ...
    public function getHtml()
    {
        ...
        if ($this->showBaseData) {
            ...
            $view = new WorkflowItemContentView($this);
            $view->model = $model;
