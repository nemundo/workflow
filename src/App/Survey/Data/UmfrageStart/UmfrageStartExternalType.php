...
class UmfrageStartExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
parent::loadType();
$this->externalModelClassName = UmfrageStartModel::class;
$this->externalTableName = "survey_umfrage_start";
