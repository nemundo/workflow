...
class UserConfigUniqueIdExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
$this->externalModelClassName = UserConfigUniqueIdModel::class;
$this->externalTableName = "userconfig_unique_id";
...
$this->value = new \Nemundo\Model\Type\Id\UniqueIdType();
