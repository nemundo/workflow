...
class UserConfigYesNoExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
parent::loadType();
$this->externalModelClassName = UserConfigYesNoModel::class;
$this->externalTableName = "userconfig_yes_no";
